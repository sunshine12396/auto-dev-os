...
import { Zap, Folder, Settings, Building2, LogOut } from 'lucide-react'
...
const navItems = [
  ...
  { icon: Zap, label: 'Skills Library', id: 'skills' },
  { icon: Building2, label: 'Organization', id: 'organization' },
  { icon: Settings, label: 'Settings', id: 'settings' },
]

export function HomeSidebar({ activeSection, onNavigate }: HomeSidebarProps) {
  return (
    <aside className="w-64 border-r border-border bg-sidebar flex flex-col">
      ...
      <div className="p-4 border-t border-border space-y-3">
        <div className="bg-sidebar-accent/10 rounded-lg p-4">
          <p className="text-sm font-semibold text-sidebar-foreground mb-1">Organization</p>
